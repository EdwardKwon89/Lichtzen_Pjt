...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale}>
      <body className={`${inter.variable} ${outfit.variable} font-sans antialiased text-slate-200 bg-brand-navy min-h-screen selection:bg-brand-violet/30 selection:text-white`}>
